...
opencv_createsamples.exe -info pos.txt -w (detection window width) -h (detection window height) (width and height correspond to how small an object it has to find, lower leads to less performance, I used 24 for both however it might lead to better performance to use a higher number initially)
